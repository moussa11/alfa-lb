...
SENSORS: tuple[AlfaSensorEntityDescription, ...] = (
    ...
    AlfaSensorEntityDescription(
        key="data_remaining_total",
        translation_key="data_remaining_total",
        icon="mdi:sigma",
        device_class=SensorDeviceClass.DATA_SIZE,
        native_unit_of_measurement=UnitOfInformation.MEGABYTES,
        suggested_unit_of_measurement=UnitOfInformation.GIGABYTES,
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda d: d.get("data_remaining_total_mb"),
    ),
    AlfaSensorEntityDescription(
        key="plan",
    ...
    AlfaSensorEntityDescription(
        ...
        native_unit_of_measurement="plans",
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda d: d.get("plan_count"),
        attrs_fn=lambda d: {"plans": d.get("plans") or []},
    ),
    AlfaSensorEntityDescription(
        key="validity",
